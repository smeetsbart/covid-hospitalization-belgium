...
class SIRXShutdownModel:
    ...
    def fit(self,t, data,max_nfev=1000,params=None,N=None,Nmax=None):
        ...
        out = minimize(self.residual, params, args=(t, data, ),max_nfev=max_nfev)
        return out
...
class SIRXQuarantineModel:
    ...
    def fit(self,t, data,max_nfev=100000,params=None,N=None,Nmax=None, **kwargs):
